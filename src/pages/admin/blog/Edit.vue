...
const handleThumbnailInput = (e) => {
  form.value.thumbnail = e.target.value
...
<template>
  <div class="p-4">
    ...
    <div v-if="notFound" class="text-center py-5 text-muted">
      ...
      <RouterLink to="/bloglist" class="btn btn-outline-secondary mt-2">
    ...
    <div v-else>
      ...
      <div class="d-flex align-items-center gap-3 mb-4">
        ...
        <div>
          ...
          <p class="text-muted small mb-0">Cập nhật nội dung bài viết #{{ route.params.id }}</p>
        </div>
      </div>
              ...
              <div class="card-body p-4">
                ...
                <div class="thumbnail-preview rounded-3 border overflow-hidden">
                  <img
                    ...
                    @error="previewUrl = ''"
                  />
                  <div v-else class="d-flex flex-column align-items-center justify-content-center bg-light" style="height:160px;">
